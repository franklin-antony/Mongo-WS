...
class BlogPostDAO:
    ...
    def get_posts(self, num_posts):
        ...
        query = {}
        cursor = self.posts.find(query)  # Using an empty itable for a placeholder so blog compiles before you make your changes
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            print(post)
            result = self.posts.update_one({'_id': post['_id']},{'$set': {'comments': post["comments"]}})
